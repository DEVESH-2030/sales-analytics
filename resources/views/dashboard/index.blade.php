            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav justify-content-end">
                        ...
                        {{-- auth user section adn log out --}}
                        @if (!empty(auth()->user()))
                        <li class="nav-item d-flex align-items-center dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle text-white font-weight-bold px-0" href="#" role="button"
                ...
                <div class="col-lg-7 mb-lg-0 mb-4">
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent">
                            <h6 class="text-capitalize">Total Sales Over Time</h6>
        ...
        new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: 3,
                    fill: true,
                    data: [10, 500, 0, 100, 40, 300, 220, 0, 250, 400, 230, 500],
                    maxBarThickness: 6,
                }, ],
            },
            options: {
